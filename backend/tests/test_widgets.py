    ...
    with sync_playwright() as p:
        ...
        for node in widgets:
            ...
            for w in node["widgets"]:
                ...
                print(
                    f'  - {w["name"]} (type={w["type"]}) hidden={hidden} combo={is_combo} display={w["display"]}'
                )
                if w.get("options"):
        ...
        page.screenshot(
            path=r"C:\Users\Administrator\Documents\ai\ComfyUI\custom_nodes\ComfyUI_Data_Manager\tests\widgets_check.png"
        )
