    ...
    with sync_playwright() as p:
        ...
        for r in check:
            ...
            for inp in r.get('inputs', []):
                ...
                print(f'    - {inp["tag"]} (type={inp["type"]}): display={inp["display"]}, visibility={inp["visibility"]}, 隐藏={is_hidden}')
                if not is_hidden:
                    all_hidden = False
        ...
        # 截图
        page.screenshot(path=r'C:\Users\Administrator\Documents\ai\ComfyUI\custom_nodes\ComfyUI_Data_Manager\tests\nodes_final.png')
