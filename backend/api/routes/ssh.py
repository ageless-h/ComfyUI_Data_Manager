...
def register_ssh_routes(server):
    ...
    """
    routes = [
        ("/dm/ssh/connect", ssh_connect_handler),
        ("/dm/ssh/disconnect", ssh_disconnect_handler),
        ("/dm/ssh/list", ssh_list_handler),
        ("/dm/ssh/info", ssh_info_handler),
        ("/dm/ssh/download", ssh_download_handler),
        ("/dm/ssh/upload", ssh_upload_handler),
        ("/dm/ssh/delete", ssh_delete_handler),
        ("/dm/ssh/hosts", ssh_list_hosts_handler),
        ("/dm/ssh/read", ssh_read_handler),
    ]
