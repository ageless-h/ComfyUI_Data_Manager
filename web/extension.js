...
// 文件类型配置
const FILE_TYPES = {
    image: { exts: ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.webp', '.svg', '.ico', '.tiff', '.tif', '.avif', '.heic', '.heif', '.tga'], icon: 'pi-image', color: '#e74c3c' },
...
function openFloatingPreview(path, fileName) {
    ...
    // PDF 全屏按钮
    if (ext === '.pdf') {
        const sepPdf = document.createElement("div");
        sepPdf.style.cssText = "width: 1px; height: 16px; background: #3a3a3a; margin: 0 4px;";
