...
import{app as L}from"../../scripts/app.js";const Xe="modulepreload",Ze=function(e){return"/"+e},le={},I=function(n,t,o){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),a=r?.nonce||r?.getAttribute("nonce");i=Promise.allSettled(t.map(c=>{if(c=Ze(c),c in le)return;le[c]=!0;const l=c.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const d=document.createElement("link");if(d.rel=l?"stylesheet":Xe,l||(d.as="script"),d.crossOrigin="",d.href=c,a&&d.setAttribute("nonce",a),document.head.appendChild(d),l)return new Promise((m,y)=>{d.addEventListener("load",m),d.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=r,window.dispatchEvent(a),!a.defaultPrevented)throw r}return i.then(r=>{for(const a of r||[])a.status==="rejected"&&s(a.reason);return n().catch(s)})},N={LAST_PATH:"comfyui_datamanager_last_path",VIEW_MODE:"comfyui_datamanager_view_mode",SORT_BY:"comfyui_datamanager_sort_by",REMOTE_CONNECTIONS:"comfyui_datamanager_remote_connections",LAST_CONNECTION:"comfyui_datamanager_last_connection"},p={currentPath:"",selectedFiles:[],currentPreviewFile:null,viewMode:"list",sortBy:"name",sortOrder:"asc",files:[],history:[],historyIndex:-1};function ne(e,n){try{localStorage.setItem(e,JSON.stringify(n))}catch(t){console.warn("[DataManager] Failed to save state:",t)}}function oe(e,n){try{const t=localStorage.getItem(e);return t?JSON.parse(t):n}catch(t){return console.warn("[DataManager] Failed to load state:",t),n}}function ie(e){ne(N.LAST_PATH,e)}function Ce(){return oe(N.LAST_PATH,".")}function Je(e){ne(N.VIEW_MODE,e)}function Ke(){return oe(N.VIEW_MODE,"list")}let Qe=null,et=null,k=[];const tt=N.REMOTE_CONNECTIONS,nt=N.LAST_CONNECTION;let z={active:null,saved:[]};function ot(){try{const e=localStorage.getItem(tt);e&&(z.saved=JSON.parse(e));const n=localStorage.getItem(nt);n&&(z.active=JSON.parse(n)),window._remoteConnectionsState?(window._remoteConnectionsState.active=z.active,window._remoteConnectionsState.saved=z.saved):window._remoteConnectionsState=z}catch(e){console.warn("[DataManager] Failed to init remote connections:",e)}}ot();const it=z,rt=Object.freeze(Object.defineProperty({__proto__:null,FileManagerState:p,STORAGE_KEYS:N,fileManagerWindow:Qe,getLastPath:Ce,getViewMode:Ke,loadState:oe,previewFloatingWindows:k,previewModal:et,remoteConnectionsState:it,saveLastPath:ie,saveState:ne,saveViewMode:Je},Symbol.toStringTag,{value:"Module"})),$e=[];function re(e){$e.push(e)}function de(){const e=v();$e.forEach(n=>{try{n(e)}catch(t){console.error("[DataManager] Theme listener error:",t)}})}function st(){const e=new MutationObserver(o=>{let i=!1;for(const s of o)if(s.type==="attributes"){i=!0;break}i&&(O(),de())});e.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]});let n=pe();const t=window.setInterval(()=>{const o=pe();JSON.stringify(n)!==JSON.stringify(o)&&(n=o,O(),de())},2e3);return{observer:e,checkInterval:t}}function pe(){const e=window.getComputedStyle(document.documentElement);return{bg:e.getPropertyValue("--comfy-menu-bg"),bg2:e.getPropertyValue("--comfy-menu-bg-2"),inputText:e.getPropertyValue("--input-text"),borderColor:e.getPropertyValue("--border-color")}}let me=null;function at(){me||setTimeout(()=>{try{me=st()}catch(e){console.error("[DataManager] Theme watcher init failed:",e)}},1e3)}function ct(e){if(e.includes("rgb")){const t=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(t){const o=parseInt(t[1]),i=parseInt(t[2]),s=parseInt(t[3]);return(o*299+i*587+s*114)/1e3>128}}const n=e.replace("#","");if(n.length===3){const t=parseInt(n[0]+n[0],16),o=parseInt(n[1]+n[1],16),i=parseInt(n[2]+n[2],16);return(t*299+o*587+i*114)/1e3>128}if(n.length===6){const t=parseInt(n.substring(0,2),16),o=parseInt(n.substring(2,4),16),i=parseInt(n.substring(4,6),16);return(t*299+o*587+i*114)/1e3>128}return!1}function v(){try{const e=window.getComputedStyle(document.documentElement),n=window.getComputedStyle(document.body),t=e.getPropertyValue("--comfy-menu-bg")?.trim()||"#1a1a1a",o=e.getPropertyValue("--comfy-menu-bg-2")?.trim()||e.getPropertyValue("--comfy-menu-secondary-bg")?.trim()||"#252525",i=ct(t),s=e.getPropertyValue("--comfy-menu-bg-3")?.trim();let r,a;i?(r="#f0f0f0",a=e.getPropertyValue("--comfy-input-bg")?.trim()||"#ffffff"):(r=s||"#2a2a2a",a=e.getPropertyValue("--comfy-input-bg")?.trim()||r);const c=e.getPropertyValue("--input-text")?.trim()||"",l=i?"#222222":"#dddddd",u=i?"#666666":"#999999";return{bgPrimary:t,bgSecondary:o,bgTertiary:r,inputBg:a,inputText:l,borderColor:e.getPropertyValue("--border-color")?.trim()||(i?"#dddddd":"#444444"),textPrimary:l,textSecondary:u,accentColor:e.getPropertyValue("--comfy-accent")?.trim()||"#9b59b6",errorColor:"#e74c3c",successColor:"#27ae60",isLight:i}}catch(e){return console.warn("[DataManager] Failed to get ComfyUI theme:",e),{bgPrimary:"#1a1a1a",bgSecondary:"#252525",bgTertiary:"#2a2a2a",inputBg:"#2a2a2a",inputText:"#dddddd",borderColor:"#444444",textPrimary:"#dddddd",textSecondary:"#999999",accentColor:"#9b59b6",errorColor:"#e74c3c",successColor:"#27ae60",isLight:!1}}}function O(){const e=v(),n=e.isLight?"#e0e0e0":"#3a3a3a",t=document.documentElement;t.style.setProperty("--dm-bg-primary",e.bgPrimary),t.style.setProperty("--dm-bg-secondary",e.bgSecondary),t.style.setProperty("--dm-bg-tertiary",e.bgTertiary),t.style.setProperty("--dm-bg-hover",n),t.style.setProperty("--dm-input-bg",e.inputBg),t.style.setProperty("--dm-input-text",e.inputText),t.style.setProperty("--dm-border-color",e.borderColor),t.style.setProperty("--dm-text-primary",e.textPrimary),t.style.setProperty("--dm-text-secondary",e.textSecondary),t.style.setProperty("--dm-accent-color",e.accentColor),t.style.setProperty("--dm-error-color",e.errorColor),t.style.setProperty("--dm-success-color",e.successColor)}function ue(e,n){e&&(e.style.background=`linear-gradient(135deg, ${n.bgSecondary} 0%, ${n.bgPrimary} 100%)`,e.style.borderColor=n.borderColor)}function lt(e={}){const{title:n="Data Manager",icon:t="pi-folder-open",onClose:o=null,onMinimize:i=null,onFullscreen:s=null,onRefresh:r=null}=e,a=v(),c=document.createElement("div");c.className="dm-header dm-preview-header",c.setAttribute("draggable","false"),c.style.cssText=`
  ...
  `;const x=document.createElement("i");x.className=`pi ${t}`,x.style.color=a.textSecondary;const f=document.createElement("span");f.style.cssText=`
    ...
    white-space: nowrap;
  `,f.textContent=n,y.appendChild(x),y.appendChild(f);const g=document.createElement("div");if(g.style.cssText="display: flex; gap: 8px; align-items: center;",r){const b=dt("pi-refresh","刷新",r);g.appendChild(b)}return c.appendChild(l),c.appendChild(y),c.appendChild(g),c._updateTheme=()=>{const b=v();ue(c,b)},re(b=>{ue(c,b)}),c}function G(e,n,t){const o=v(),i=document.createElement("button");return i.className="comfy-btn dm-traffic-btn",i.innerHTML=`<i class="pi ${e}" style="font-size: 12px;"></i>`,i.style.cssText=`
    width: 28px;
    height: 28px;
    padding: 0;
    background: transparent;
  ...
  `,t.title="新建",t.onclick=()=>{e.onNewFile&&e.onNewFile()},t}function ut(e){const n=v(),t=document.createElement("select");return t.id="dm-sort-select",t.className="dm-select comfy-btn",t.style.cssText=`
    padding: 8px 12px;
    border: 1px solid ${n.borderColor} !important;
    border-radius: 6px;
    font-size: 13px;
  ...
  `,[{value:"name",label:"按名称"},{value:"size",label:"按大小"},{value:"modified",label:"按日期"}].forEach(i=>{const s=document.createElement("option");s.value=i.value,s.textContent=i.label,t.appendChild(s)}),t.onchange=i=>{const s=i.target.value;e.onSortChange&&e.onSortChange(s)},t}function ft(e){const{onSshConnect:n,onSshDisconnect:t}=e,o=v(),i=document.createElement("button");return i.className="comfy-btn",i.id="dm-settings-btn",i.innerHTML='<i class="pi pi-cog"></i>',i.style.cssText=`
    padding: 8px 12px;
    border: 1px solid ${o.borderColor} !important;
    border-radius: 6px;
    cursor: pointer;
  ...
  `}function ye(e,n){const t=v();if(n)return`
  ...
  `,n.appendChild(t),n.appendChild(o),setTimeout(()=>{const i=v(),s=document.getElementById("dm-connection-indicator"),r=document.getElementById("dm-connection-status"),c=window._remoteConnectionsState?.active;if(s&&(s.style.background=c?i.successColor:i.textSecondary),r&&c){const l=c;r.textContent=`SSH: ${l.username}@${l.host}`}},100),n}function Te(e,n){e.draggable=!1,n.draggable=!1,e.addEventListener("dragstart",t=>(t.preventDefault(),t.stopPropagation(),!1)),n.addEventListener("mousedown",t=>{if(t.target&&t.target.tagName==="BUTTON"||t.target.tagName==="I"||e.dataset.fullscreen==="true")return;t.preventDefault();const o=e.getBoundingClientRect(),i=t.clientX-o.left,s=t.clientY-o.top;e.style.transition="none",e.style.transform="none",e.style.left=o.left+"px",e.style.top=o.top+"px",e._isDragging=!0;const r=c=>{if(!e._isDragging)return;const l=c.clientX-i,u=c.clientY-s;e.style.left=Math.max(0,l)+"px",e.style.top=Math.max(0,u)+"px"},a=()=>{e.style.transition="",e._isDragging=!1,document.removeEventListener("mousemove",r),document.removeEventListener("mouseup",a)};document.addEventListener("mousemove",r),document.addEventListener("mouseup",a)})}let j=null;function Mt(e={}){const n=v(),t=document.createElement("div");t.id="dm-file-manager",t.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
  ...
  `,o.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transform="translateY(-10px)",a.style.transition="all 0.3s ease-in",setTimeout(()=>a.remove(),300)},3e3)}function ee(e){const n=e.replace(/\\/g,"/"),t=n.lastIndexOf("/");return t<=0?".":n.substring(0,t)}function _e(e){return e.split(/[/\\]/).pop()||""}function At(e){return"."+(e.split(".").pop()?.toLowerCase()||"")}async function M(e){const n=window._remoteConnectionsState?.active;if(n){await Ft(e,n);return}P(`正在加载: ${e}...`);try{const t=await Se(e);p.files=t.files||[],p.currentPath=t.path,ie(t.path),(p.historyIndex===-1||p.history[p.historyIndex]!==t.path)&&(p.history=p.history.slice(0,p.historyIndex+1),p.history.push(t.path),p.historyIndex=p.history.length-1);const o=document.getElementById("dm-path-input");o&&(o.value=t.path),V(),P(`${p.files.length} 个项目`)}catch(t){console.error("Load directory error:",t),P("加载错误"),T("error","错误","网络请求失败")}}async function Ft(e,n){P(`正在加载远程: ${e}...`);try{const{sshList:t}=await I(async()=>{const{sshList:s}=await import("./ssh.js");return{sshList:s}},[]),o=await t(n.connection_id,e||n.root_path||"/");p.files=o.files||[],p.currentPath=o.path||e;const i=document.getElementById("dm-path-input");i&&(i.value=`[SSH] ${o.path}`),V(),P(`${p.files.length} 个项目 (远程)`)}catch(t){console.error("Load remote directory error:",t),P("加载错误"),T("error","错误",`远程加载失败: ${t.message}`)}}function V(){const e=document.getElementById("dm-file-list");if(!e)return;p.selectedFiles=[];const n=[...p.files].sort((o,i)=>{const s=o.is_dir||o.isDir||!1,r=i.is_dir||i.isDir||!1;if(s&&!r)return-1;if(!s&&r)return 1;let a=0;switch(p.sortBy){case"name":a=o.name.localeCompare(i.name);break;case"size":a=(o.size||0)-(i.size||0);break;case"modified":a=new Date(o.modified||0).getTime()-new Date(i.modified||0).getTime();break}return p.sortOrder==="asc"?a:-a});let t="";p.currentPath!=="."&&p.currentPath!=="/"&&(p.viewMode==="list"?t+=fe({name:"..",path:ee(p.currentPath),size:0,modified:void 0}):t+=ye({name:"..",path:ee(p.currentPath)},!0)),n.forEach(o=>{t+=p.viewMode==="list"?fe(o):ye(o,!1)}),e.innerHTML=t,e.scrollTop=0,e.querySelectorAll(".dm-file-item").forEach(o=>{o.onclick=()=>Bt(o),o.ondblclick=()=>jt(o)}),e.querySelectorAll(".dm-grid-item").forEach(o=>{o.onclick=()=>Ht(o),o.ondblclick=async()=>{const i=o.dataset.path;if(o.dataset.isDir==="true"&&i)await M(i);else if(i){const{previewFile:r}=await I(async()=>{const{previewFile:a}=await import("./preview-actions.js");return{previewFile:a}},[]);await r(i)}}})}function Ie(){const e=document.getElementById("dm-copy-path-btn");if(!e)return;const n=p.selectedFiles.length>0;e.disabled=!n,e.style.opacity=n?"1":"0.5",e.style.cursor=n?"pointer":"not-allowed"}function Bt(e){const n=v();document.querySelectorAll(".dm-file-item").forEach(i=>{i.style.background="transparent"}),e.style.background=`${n.bgTertiary} !important`;const t=e.dataset.path||"",o=e.dataset.isDir==="true";p.selectedFiles=[t],Ie(),!o&&t?(async()=>{const{previewFile:i}=await I(async()=>{const{previewFile:s}=await import("./preview-actions.js");return{previewFile:s}},[]);await i(t)})():Rt()}function Ht(e){const n=v();document.querySelectorAll(".dm-grid-item").forEach(i=>{i.style.borderColor="transparent"}),e.style.borderColor=`${n.accentColor} !important`,p.selectedFiles=[e.dataset.path||""],Ie();const t=e.dataset.path;!(e.dataset.isDir==="true")&&t&&(async()=>{const{previewFile:i}=await I(async()=>{const{previewFile:s}=await import("./preview-actions.js");return{previewFile:s}},[]);await i(t)})()}function jt(e){const n=e.dataset.path;e.dataset.isDir==="true"&&n?M(n):n&&(async()=>{const{previewFile:o}=await I(async()=>{const{previewFile:i}=await import("./preview-actions.js");return{previewFile:i}},[]);await o(n)})()}function Rt(){const e=document.getElementById("dm-preview-content");if(e){const n=v();e.innerHTML=`
...
`?(t.push(o),n.push(t),t=[],o=""):r!=="\r"&&(o+=r)}return t.push(o),(t.length>0||n.length>0)&&n.push(t),n}const Xt={type:"floating",maxRows:_.MAX_PREVIEW_ROWS,height:null},te={floating:{containerClass:"dm-table-container",controlsClass:"dm-table-controls",height:null,hasFullscreen:!1,prefix:"dm-floating-table"},panel:{containerClass:"dm-panel-table-container",controlsClass:"dm-table-controls-panel",height:null,hasFullscreen:!0,prefix:"dm-table"}};function Re(e,n={}){const t={...Xt,...n},o=te[t.type||"floating"],i=t.hasFullscreen!==void 0?t.hasFullscreen:o.hasFullscreen,s=e.slice(0,t.maxRows||_.MAX_PREVIEW_ROWS),r=e.length>(t.maxRows||_.MAX_PREVIEW_ROWS),a=`${o.prefix}-${Date.now()}`,c=t.path||"",l=o.height!==null?`height: ${o.height};`:"height: 100%;",u=`position: relative; flex: 1; overflow: hidden; ${l}`;let d=`
  ...
  `}async function qe(e,n){const t=await fetch(`/dm/preview?path=${encodeURIComponent(e)}`);if(!t.ok)throw new Error("Failed to load file");if(n===".csv"){const o=await t.text();return Yt(o)}if(n===".xls"||n===".xlsx"){const o=window;typeof o.XLSX>"u"&&await je("https://cdn.sheetjs.com/xlsx-0.20.2/package/dist/xlsx.full.min.js");const i=await t.arrayBuffer(),s=o.XLSX,r=s.read(i,{type:"array"}),a=r.SheetNames[0],c=r.Sheets[a];return s.utils.sheet_to_json(c,{header:1})}throw new Error("Unsupported spreadsheet format")}const En=Object.freeze(Object.defineProperty({__proto__:null,createTableErrorHTML:Ve,createTableHTML:Re,parseSpreadsheet:qe,setupTableControls:Ue},Symbol.toStringTag,{value:"Module"}));function Jt(e){if(typeof e!="string")return String(e??"");let n=e;const t=/function\s*\(\s*\)\s*\{[\s\S]*?\}/g;n=n.replace(t,"");const o=/function\s*\(\s*\)\s*\{\s*(return\s+)?[\w.]*\.?(?:_?target|value)\s*(?:\.call\([^)]*\))?[\s;]*\}/g;n=n.replace(o,"");const i=/\{[^}]*_target[^}]*\}/g;return n=n.replace(i,""),n}async function Kt(e,n,t,o=1,i){const s=v();e.innerHTML=`
  ...
  `;try{let r="";if(w.image.exts.includes(t)){const a=`/dm/preview?path=${encodeURIComponent(n)}`;r=`
      ...
      `}else if(w.code.exts.includes(t)){const a=await fetch(`/dm/preview?path=${encodeURIComponent(n)}`);if(a.ok){const c=await a.text();r=`
        ...
        `;else if(u)try{const m=await fetch(a);if(m.ok){const y=await m.arrayBuffer();if(typeof window.mammoth>"u"){console.log("[DataManager] Loading mammoth.js...");try{await je("https://cdnjs.cloudflare.com/ajax/libs/mammoth/1.6.0/mammoth.browser.min.js"),console.log("[DataManager] mammoth.js loaded successfully")}catch(f){throw console.error("[DataManager] Failed to load mammoth.js:",f),new Error("无法加载 mammoth.js，请检查网络连接")}}const x=window.mammoth;if(x){const g=(await x.convertToHtml({arrayBuffer:y})).value,b=Jt(g),C=`dm-doc-content-${Date.now()}`;r=`
                <div id="${C}" class="dm-document-content dm-docx-content"
                     style="width: 100%; height: 100%;
                            ...
                            padding: 20px;">
                  <style>
                    #${C} img { max-width: 100%; height: auto; display: inline-block; margin: 10px 0; }
                    #${C} p { word-wrap: break-word; overflow-wrap: break-word; margin: 0.5em 0; }
                    #${C} table { max-width: 100%; overflow: auto; display: block; margin: 10px 0; }
                  </style>
                  ${b}
                </div>
      ...
      `}e.innerHTML=r,Qt(e,n)}catch(r){e.innerHTML=`
      <div class="dm-preview-error" style="text-align: center; padding: 40px;">
        <i class="pi pi-exclamation-triangle dm-error-icon" style="font-size: 48px;"></i>
    ...
    `}}async function Qt(e,n){const t=e.parentElement?.querySelector(".dm-floating-file-info");if(t)try{const o=await Ot(n);t.innerHTML=`
      <div style="display: flex; justify-content: space-between; gap: 15px;">
        <span>${E(o.name)}</span>
        <span>${Ee(o.size)}</span>
      </div>
    `}catch{t.innerHTML='<span style="opacity: 0.5;">无法获取文件信息</span>'}}function ae(){const e=document.getElementById("dm-preview-dock");if(!e)return;const n=v();e.innerHTML="";const t=k.filter(o=>o.minimized);if(t.length===0){e.style.minHeight="0",e.style.maxHeight="0",e.style.padding="0 15px";return}e.style.minHeight="60px",e.style.maxHeight="60px",e.style.padding="10px 15px",t.forEach(o=>{const i=document.createElement("div");i.className="dm-dock-thumbnail",i.style.cssText=`
      width: 80px;
      height: 50px;
    ...
    flex-direction: column;
    overflow: hidden;
  `;const g=sn(n,r,a,c,l,m,y,x,f);f.appendChild(g);const b=document.createElement("div");b.id=`dm-preview-content-${Date.now()}`,b.style.cssText=`
    flex: 1;
    overflow: auto;
    display: flex;
    align-items: center;
    justify-content: center;
    background: ${o.bgPrimary};
  `,f.appendChild(b);const{toolbar:C,mediaId:S}=an(e,i,a,c,l,u,d,y,x,b,f);f.appendChild(C);const $=document.createElement("div");$.id=`dm-fileinfo-${Date.now()}`,$.className="dm-floating-file-info",$.style.cssText=`
    padding: 10px 15px;
    ...
    color: ${o.textSecondary};
    text-align: center;
  `,$.innerHTML='<span style="opacity: 0.5;">正在加载...</span>',f.appendChild($),document.body.appendChild(f),O(),Te(f,g);const B={path:e,fileName:n,fileConfig:r,window:f,minimized:!1};k.push(B),Kt(b,e,i,tn,S),P(`已打开预览: ${n}`)}function sn(e,n,t,o,i,s,r,a,c,l){const u=v(),d=u.isLight?"#222":"#fff",m=document.createElement("div");m.className="dm-preview-header",m.style.cssText=`
    display: flex;
    justify-content: space-between;
    align-items: center;
    padding: 12px 15px;
    ...
    cursor: move;
    user-select: none;
  `;const y=document.createElement("div");y.className="dm-traffic-lights",y.style.cssText="display: flex; gap: 8px;";const x=J("pi-times",d,"关闭",()=>cn(c));y.appendChild(x);const f=J("pi-minus",d,"最小化",()=>ln(c));if(y.appendChild(f),t||o||i||s||r||a){const b=J("pi-window-maximize",d,"全屏",()=>R(c));y.appendChild(b)}m.appendChild(y);const g=document.createElement("div");return g.className="dm-header-title-area",g.style.cssText="display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600; flex: 1; justify-content: center;",g.innerHTML=`
  ...
  `,m.appendChild(g),re(b=>{const C=b.isLight?"#222":"#fff";m.style.background=`linear-gradient(135deg, ${b.bgSecondary} 0%, ${b.bgPrimary} 100%)`,m.style.borderColor=b.borderColor,g.style.color=C,m.querySelectorAll(".dm-traffic-btn").forEach($=>{$.style.color=C})}),m}function J(e,n,t,o){const i=document.createElement("button");return i.className="comfy-btn dm-traffic-btn",i.innerHTML=`<i class="pi ${e}" style="font-size: 10px; color: ${n};"></i>`,i.style.cssText=`
    width: 14px;
    height: 14px;
    padding: 0px;
    background: transparent;
    ...
    justify-content: center;
    transition: 0.15s;
  `,i.title=t,i.onclick=s=>{s.stopPropagation(),o()},i}function ve(e,n,t,o,i){const s=v();let r=t.defaultSize;e.appendChild(i());const a=o(X.MINUS,Z.DECREASE_FONT,()=>{r=Math.max(t.minSize,r-1),d()});e.appendChild(a);const c=document.createElement("span");c.style.cssText=`min-width: ${rn}px; text-align: center; color: ${s.textSecondary};`,c.textContent=r.toString(),e.appendChild(c);const l=o(X.PLUS,Z.INCREASE_FONT,()=>{r=Math.min(t.maxSize,r+1),d()});e.appendChild(l);const u=o(X.UNDO,Z.RESET_FONT,()=>{r=t.defaultSize,d()});e.appendChild(u);function d(){c.textContent=r.toString();const m=n.querySelector(t.selector);m&&(m.style.fontSize=`${r}px`)}}function Ge(e,n,t,o,i,s,r,a){const c=v(),l=n.querySelector(`#${a}`);if(!l){setTimeout(()=>Ge(e,n,t,o,i,s,r,a),50);return}const u=document.createElement("span");u.className="dm-media-time",u.style.cssText=`min-width: 80px; text-align: center; color: ${c.textSecondary}; font-size: 11px; font-family: monospace;`,u.textContent="0:00 / 0:00",u.id=`${a}-time`,e.appendChild(u),e.appendChild(s());const d=i("pi-volume-up","音量",()=>{l.muted?(l.muted=!1,d.innerHTML='<i class="pi pi-volume-up"></i>',d.title="音量"):(l.muted=!0,d.innerHTML='<i class="pi pi-volume-off"></i>',d.title="静音")});e.appendChild(d),l.addEventListener("volumechange",()=>{l.muted||l.volume===0?d.innerHTML='<i class="pi pi-volume-off"></i>':l.volume<.5?d.innerHTML='<i class="pi pi-volume-down"></i>':d.innerHTML='<i class="pi pi-volume-up"></i>'}),e.appendChild(s());const m=i("pi-play","播放",()=>{l.paused?l.play().then(()=>{m.innerHTML='<i class="pi pi-pause"></i>',m.title="暂停"}).catch(f=>console.error("[DataManager] 播放失败:",f)):(l.pause(),m.innerHTML='<i class="pi pi-play"></i>',m.title="播放")});e.appendChild(m),l.addEventListener("play",()=>{m.innerHTML='<i class="pi pi-pause"></i>',m.title="暂停"}),l.addEventListener("pause",()=>{m.innerHTML='<i class="pi pi-play"></i>',m.title="播放"});function y(f){if(isNaN(f))return"0:00";const g=Math.floor(f/60),b=Math.floor(f%60);return`${g}:${b.toString().padStart(2,"0")}`}if(l.addEventListener("loadedmetadata",()=>{u.textContent=`0:00 / ${y(l.duration)}`}),l.addEventListener("timeupdate",()=>{u.textContent=`${y(l.currentTime)} / ${y(l.duration||0)}`}),o){e.appendChild(s());const f=i("pi-arrows-alt","全屏",()=>{R(r)});e.appendChild(f)}e.appendChild(s());const x=i("pi-external-link","打开",()=>{window.open(`/dm/preview?path=${encodeURIComponent(t)}`,"_blank")});e.appendChild(x)}function an(e,n,t,o,i,s,r,a,c,l,u){const d=v(),m=document.createElement("div");m.className="dm-preview-toolbar",m.style.cssText=`
    padding: 12px 16px;
  ...
  `;const y=document.createElement("div");y.style.cssText="display: flex; gap: 8px; align-items: center; flex-shrink: 0;";const x=document.createElement("div");x.style.cssText="flex: 1; text-align: center; overflow: hidden; padding: 0 20px;";const f=document.createElement("div");f.style.cssText="display: flex; gap: 8px; align-items: center; flex-shrink: 0;";function g(){const S=document.createElement("div");return S.style.cssText=`width: 1px; height: 16px; background: ${d.borderColor}; margin: 0 4px;`,S}t&&y.appendChild(g()),(n===".txt"||n===".rtf"||n===".md"||n===".docx")&&ve(y,l,{defaultSize:nn,minSize:xe,maxSize:he,selector:be.DOCUMENT_CONTENT},D,g),a&&ve(y,l,{defaultSize:on,minSize:xe,maxSize:he,selector:be.CODE_CONTENT},D,g);const b=document.createElement("div");b.className="dm-file-path",b.style.cssText=`overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: ${d.textSecondary};`,b.textContent=e,b.title=e,x.appendChild(b),f.appendChild(g());let C;if(t)C=`dm-floating-image-${Date.now()}`,ce(f,C,l,e,D,g);else if(o||i)C=o?`dm-preview-video-${Date.now()}`:`dm-preview-audio-${Date.now()}`,Ge(f,l,e,o,D,g,u,C);else{const S=D("pi-external-link","打开",()=>{window.open(`/dm/preview?path=${encodeURIComponent(e)}`,"_blank")});f.appendChild(S)}if(s){f.appendChild(g());const S=D("pi-arrows-alt","PDF 全屏",()=>{const $=document.getElementById("dm-floating-pdf-embed");$&&$.requestFullscreen?$.requestFullscreen().catch(B=>console.error("[DataManager] PDF 全屏失败:",B)):$&&$.webkitRequestFullscreen&&$.webkitRequestFullscreen()});f.appendChild(S)}if(n===".md"||n===".txt"||n===".rtf"){f.appendChild(g());const S=D("pi-arrows-alt","全屏预览",()=>R(u));f.appendChild(S)}if(a){f.appendChild(g());const S=D("pi-arrows-alt","全屏预览",()=>R(u));f.appendChild(S)}if(c){f.appendChild(g());const S=D("pi-arrows-alt","全屏预览",()=>R(u));f.appendChild(S)}return m.appendChild(y),m.appendChild(x),m.appendChild(f),{toolbar:m,mediaId:C}}function ce(e,n,t,o,i,s){const r=v(),a=t.querySelector(`#${n}`);if(!a){setTimeout(()=>ce(e,n,t,o,i,s),50);return}let c=100,l=0,u=0;const d=document.createElement("span");d.id=`${n}-zoom`,d.className="dm-zoom-level",d.style.cssText=`min-width: 45px; text-align: center; font-size: 13px; color: ${r.textSecondary};`,d.textContent="100%",e.appendChild(d);function m(){const $=c/100;a.style.transform=`translate(${l}px, ${u}px) scale(${$})`,d.textContent=`${c}%`,c>100?(a.style.maxWidth="none",a.style.maxHeight="none"):(a.style.maxWidth="100%",a.style.maxHeight="100%")}const y=i("pi-search-minus","缩小",()=>{c=Math.max(c-_.DEFAULT_ZOOM_STEP,_.MIN_ZOOM_DISPLAY),m()});e.appendChild(y);const x=i("pi-search-plus","放大",()=>{c=Math.min(c+_.DEFAULT_ZOOM_STEP,_.MAX_ZOOM_DISPLAY),m()});e.appendChild(x);const f=i("pi-undo","重置",()=>{c=100,l=0,u=0,m()});e.appendChild(f),e.appendChild(s());const g=i("pi-external-link","打开",()=>{window.open(`/dm/preview?path=${encodeURIComponent(o)}`,"_blank")});e.appendChild(g);const b=a.parentElement;b&&b.addEventListener("wheel",$=>{$.preventDefault();const B=$.deltaY>0?-25:_.DEFAULT_ZOOM_STEP;c=Math.max(_.MIN_ZOOM_DISPLAY,Math.min(_.MAX_ZOOM_DISPLAY,c+B)),m()},{passive:!1});let C=!1,S={x:0,y:0};a.addEventListener("mousedown",$=>{c<=100||(C=!0,S={x:$.clientX-l,y:$.clientY-u},a.style.cursor="grabbing")}),document.addEventListener("mousemove",$=>{C&&(l=$.clientX-S.x,u=$.clientY-S.y,m())}),document.addEventListener("mouseup",()=>{C&&(C=!1,a.style.cursor="grab")})}function cn(e){const n=k.findIndex(t=>t.window===e);n>-1&&k.splice(n,1),e.remove(),ae()}function ln(e,n,t,o){const i=k.find(s=>s.window===e);i&&(i.minimized=!0),e.style.display="none",ae()}function R(e){e.dataset.fullscreen==="true"?(e.dataset.fullscreen="false",e.style.top="100px",e.style.right="50px",e.style.width="500px",e.style.height="600px"):(e.dataset.fullscreen="true",e.style.top="0",e.style.right="0",e.style.width="100vw",e.style.height="100vh",e.style.borderRadius="0")}const dn=Object.freeze(Object.defineProperty({__proto__:null,openFloatingPreview:We,setupImageToolbarControls:ce},Symbol.toStringTag,{value:"Module"})),pn=2,mn=typeof L.ui<"u"&&L.ui!==null&&L.ui?.version&&typeof L.ui.version=="object"&&L.ui.version.major&&L.ui.version.major>=pn;console.log(`[DataManager] Extension loading, Node V${mn?"3":"1"} detected`);let K=null;const un={name:"ComfyUI.DataManager",commands:[{id:"data-manager.open",label:"Open Data Manager",icon:"pi pi-folder-open",function:()=>H()}],keybindings:[{combo:{key:"d",ctrl:!0,shift:!0},commandId:"data-manager.open"}],actionBarButtons:[{icon:"pi pi-folder",tooltip:"文件管理器 (Ctrl+Shift+D)",class:"dm-actionbar-btn",onClick:()=>H()}],async setup(){window.FileManagerState=p,O();const e=document.createElement("style");e.textContent=`
      .dm-actionbar-btn {
    ...
    `,document.head.appendChild(e);const n=()=>{try{O();const r=document.documentElement.style.getPropertyValue("--dm-bg-tertiary")}catch(s){console.warn("[DataManager] Theme apply error:",s)}};n(),setTimeout(n,0),setTimeout(n,100),setTimeout(n,500);const t=()=>{const s=document.querySelector(".dm-actionbar-btn"),r=Array.from(document.querySelectorAll("button")).find(l=>l.getAttribute("aria-label")==="Expand job queue");if(!s||!r)return!1;O();const a=r.parentElement;return r.previousElementSibling!==s||s.parentElement!==a?(a.insertBefore(s,r),!0):!1};let o=0;new MutationObserver(s=>{const r=Date.now();if(r-o<100)return;o=r,s.some(c=>{if(c.type==="childList"){for(const l of c.addedNodes)if(l.nodeType===1){const u=l;if(u.classList?.contains("actionbar-container")||u.classList?.contains("dm-actionbar-btn")||u.querySelector?.(".dm-actionbar-btn")||u.querySelector?.('[aria-label="Expand job queue"]'))return!0}}return!!c.target.closest?.(".actionbar-container")})&&requestAnimationFrame(t)}).observe(document.body,{childList:!0,subtree:!0}),setInterval(()=>{t()},2e3),console.log("[DataManager] Extension setup completed"),at(),re(s=>{document.querySelectorAll(".dm-node-open-btn").forEach(r=>{const a=r;a.style.background=s.bgTertiary,a.style.borderColor=s.borderColor,a.style.color=s.textPrimary})})},async nodeCreated(e){const n=e;if(n.comfyClass==="DataManagerCore"){if(n.addDOMWidget){O();const t=v(),o=document.createElement("div");o.style.cssText=`
        ...
        `,i.onmouseover=()=>{i.style.background=t.bgSecondary,i.style.transform="translateY(-1px)",i.style.borderColor=t.accentColor,i.style.boxShadow="0 4px 8px rgba(0, 0, 0, 0.3)"},i.onmouseout=()=>{i.style.background=t.bgTertiary,i.style.transform="translateY(0)",i.style.borderColor=t.borderColor,i.style.boxShadow="0 2px 4px rgba(0, 0, 0, 0.2)"},i.onclick=s=>{s.stopPropagation(),H()},o.appendChild(i),n.addDOMWidget("dm_open_btn","dm_open_btn",o,{minWidth:200,minHeight:50})}}else if(n.comfyClass==="InputPathConfig")n._dmFormatSelectorEnabled=!1;else if(n.comfyClass==="OutputPathConfig"){const t=n;t._dmOutputType="STRING",t._dmFilePath=""}},getNodeMenuItems(e){return e.comfyClass==="DataManagerCore"?[{content:"打开文件管理器",callback:()=>H()}]:[]},getCanvasMenuItems(){return[null,{content:"Data Manager",callback:()=>H()}]}};function H(){K&&ge();const e=Ce();e&&e!=="."?p.currentPath=e:p.currentPath=".",K=Mt({onRefresh:()=>M(p.currentPath),onClose:()=>{ge(),K=null},onOpenFloating:()=>{const t=p.selectedFiles[0];t&&We(t,_e(t))},onCopyPath:()=>yn(),onDelete:()=>gn(),onSortChange:t=>{Pe(t)},onNewFile:()=>xn(),onSshConnect:async t=>{const o=t,i=window._remoteConnectionsState;i.active=t;try{localStorage.setItem("comfyui_datamanager_last_connection",JSON.stringify(t))}catch{}await M(o.root_path||"/"),T("success","已连接",`SSH: ${o.username}@${o.host}`)},onSshDisconnect:async()=>{const t=window._remoteConnectionsState,o=t.active;if(o&&o.connection_id)try{const{sshDisconnect:i}=await I(async()=>{const{sshDisconnect:s}=await import("./ssh.js");return{sshDisconnect:s}},[]);await i(o.connection_id)}catch(i){console.log("[DataManager] SSH disconnect error:",i)}t.active=null;try{localStorage.removeItem("comfyui_datamanager_last_connection")}catch{}await M("."),T("info","已断开","SSH 连接已断开")}}),O(),M(p.currentPath),setTimeout(()=>{fn()},500)}function fn(){try{Tt()}catch(e){console.log("[DataManager] Error in checkAndUpdateFormatSelector:",e)}}function yn(){const e=p.selectedFiles;if(e.length===0){T("warn","未选择","请先选择文件");return}const n=e.join(`
`);navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(n).then(()=>{T("success","已复制",`已复制 ${e.length} 个文件路径`)}).catch(()=>{we(n)}):we(n)}function we(e){const n=document.createElement("textarea");n.value=e,n.style.position="fixed",n.style.left="-999999px",n.style.top="-999999px",document.body.appendChild(n),n.focus(),n.select();try{document.execCommand("copy")?T("success","已复制",`已复制 ${p.selectedFiles.length} 个文件路径`):T("error","复制失败","无法复制到剪贴板")}catch(t){console.error("[DataManager] Fallback copy failed:",t),T("error","复制失败","无法访问剪贴板")}document.body.removeChild(n)}async function gn(){const e=p.selectedFiles;if(e.length===0){T("warn","未选择","请先选择文件");return}const n=e.length===1?`确定删除 "${_e(e[0])}"?`:`确定删除 ${e.length} 个项目?`;if(confirm(n))try{for(const t of e)await Nt(t,!0);T("success","已删除",`已删除 ${e.length} 个项目`),M(p.currentPath)}catch(t){T("error","删除失败",t.message)}}function xn(){const e=v(),n=document.createElement("div");n.style.cssText=`
    position: fixed; top: 0; left: 0; right: 0; bottom: 0;
    background: rgba(0, 0, 0, 0.7); z-index: 10001;
    display: flex; align-items: center; justify-content: center;
  `;const t=document.createElement("div");t.style.cssText=`
    background: ${e.bgSecondary}; border-radius: 12px; padding: 24px;
    width: 400px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5);
  `,t.innerHTML=`
    <h3 style="margin: 0 0 20px 0; color: ${e.textPrimary};">新建</h3>
    <div style="display: flex; gap: 10px; margin-bottom: 20px;">
      <button id="dm-new-file-btn" class="comfy-btn"
              style="flex: 1; padding: 15px; background: ${e.bgTertiary}; border: 1px solid ${e.borderColor};
                     border-radius: 8px; color: ${e.textPrimary}; cursor: pointer;">
    ...
    <button class="comfy-btn" id="dm-cancel-new-btn"
            style="width: 100%; padding: 10px; background: transparent;
                   border: 1px solid ${e.borderColor}; border-radius: 6px; color: ${e.textSecondary}; cursor: pointer;">
      取消
    </button>
  `,n.appendChild(t),document.body.appendChild(n);const o=t.querySelector("#dm-new-file-btn"),i=t.querySelector("#dm-new-folder-btn"),s=t.querySelector("#dm-cancel-new-btn");o.onclick=()=>{n.remove(),hn()},i.onclick=()=>{n.remove(),bn()},s.onclick=()=>n.remove(),n.onclick=r=>{r.target===n&&n.remove()}}async function hn(){const e=prompt("输入文件名:","new_file.txt");if(e)try{await kt(p.currentPath,e,""),await M(p.currentPath),T("success","成功",`文件已创建: ${e}`)}catch(n){const t=n.message;t.includes("File already exists")||t.includes("已存在")?T("error","创建失败",`文件 "${e}" 已存在，请使用其他文件名`):t.includes("Directory not found")||t.includes("目录不存在")?T("error","创建失败","目录不存在"):T("error","创建失败",t)}}async function bn(){const e=prompt("输入文件夹名称:","新建文件夹");if(e)try{await Lt(p.currentPath,e),await M(p.currentPath),T("success","成功",`文件夹已创建: ${e}`)}catch(n){const t=n.message;t.includes("File exists")||t.includes("已存在")?T("error","创建失败",`文件夹 "${e}" 已存在，请使用其他名称`):t.includes("Directory not found")||t.includes("目录不存在")?T("error","创建失败","父目录不存在"):T("error","创建失败",t)}}L.registerExtension(un);export{dn as A,w as F,_ as L,I as _,wn as a,Cn as b,v as c,_e as d,E as e,Ot as f,At as g,Ee as h,Oe as i,ke as j,Le as k,je as l,Ne as m,ze as n,Ae as o,Fe as p,Be as q,He as r,Re as s,Ue as t,P as u,Ve as v,qe as w,rt as x,$n as y,En as z};
