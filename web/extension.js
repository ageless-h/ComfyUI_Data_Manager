import{app as L}from"../../scripts/app.js";const qe="modulepreload",We=function(e){return"/"+e},ae={},I=function(n,t,o){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),a=r?.nonce||r?.getAttribute("nonce");i=Promise.allSettled(t.map(c=>{if(c=We(c),c in ae)return;ae[c]=!0;const l=c.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const d=document.createElement("link");if(d.rel=l?"stylesheet":qe,l||(d.as="script"),d.crossOrigin="",d.href=c,a&&d.setAttribute("nonce",a),document.head.appendChild(d),l)return new Promise((m,y)=>{d.addEventListener("load",m),d.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(r){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=r,window.dispatchEvent(a),!a.defaultPrevented)throw r}return i.then(r=>{for(const a of r||[])a.status==="rejected"&&s(a.reason);return n().catch(s)})},z={LAST_PATH:"comfyui_datamanager_last_path",VIEW_MODE:"comfyui_datamanager_view_mode",SORT_BY:"comfyui_datamanager_sort_by",REMOTE_CONNECTIONS:"comfyui_datamanager_remote_connections",LAST_CONNECTION:"comfyui_datamanager_last_connection"},p={currentPath:"",selectedFiles:[],currentPreviewFile:null,viewMode:"list",sortBy:"name",sortOrder:"asc",files:[],history:[],historyIndex:-1};function ee(e,n){try{localStorage.setItem(e,JSON.stringify(n))}catch(t){console.warn("[DataManager] Failed to save state:",t)}}function te(e,n){try{const t=localStorage.getItem(e);return t?JSON.parse(t):n}catch(t){return console.warn("[DataManager] Failed to load state:",t),n}}function ne(e){ee(z.LAST_PATH,e)}function he(){return te(z.LAST_PATH,".")}function Ge(e){ee(z.VIEW_MODE,e)}function Ye(){return te(z.VIEW_MODE,"list")}let Xe=null,Ze=null,O=[];const Je=z.REMOTE_CONNECTIONS,Ke=z.LAST_CONNECTION;let N={active:null,saved:[]};function Qe(){try{const e=localStorage.getItem(Je);e&&(N.saved=JSON.parse(e));const n=localStorage.getItem(Ke);n&&(N.active=JSON.parse(n)),window._remoteConnectionsState?(window._remoteConnectionsState.active=N.active,window._remoteConnectionsState.saved=N.saved):window._remoteConnectionsState=N}catch(e){console.warn("[DataManager] Failed to init remote connections:",e)}}Qe();const et=N,tt=Object.freeze(Object.defineProperty({__proto__:null,FileManagerState:p,STORAGE_KEYS:z,fileManagerWindow:Xe,getLastPath:he,getViewMode:Ye,loadState:te,previewFloatingWindows:O,previewModal:Ze,remoteConnectionsState:et,saveLastPath:ne,saveState:ee,saveViewMode:Ge},Symbol.toStringTag,{value:"Module"})),be=[];function oe(e){be.push(e)}function ce(){const e=b();be.forEach(n=>{try{n(e)}catch(t){console.error("[DataManager] Theme listener error:",t)}})}function nt(){const e=new MutationObserver(o=>{let i=!1;for(const s of o)if(s.type==="attributes"){i=!0;break}i&&(k(),ce())});e.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme"]});let n=le();const t=window.setInterval(()=>{const o=le();JSON.stringify(n)!==JSON.stringify(o)&&(n=o,k(),ce())},2e3);return{observer:e,checkInterval:t}}function le(){const e=window.getComputedStyle(document.documentElement);return{bg:e.getPropertyValue("--comfy-menu-bg"),bg2:e.getPropertyValue("--comfy-menu-bg-2"),inputText:e.getPropertyValue("--input-text"),borderColor:e.getPropertyValue("--border-color")}}let de=null;function ot(){de||setTimeout(()=>{try{de=nt()}catch(e){console.error("[DataManager] Theme watcher init failed:",e)}},1e3)}function it(e){if(e.includes("rgb")){const t=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(t){const o=parseInt(t[1]),i=parseInt(t[2]),s=parseInt(t[3]);return(o*299+i*587+s*114)/1e3>128}}const n=e.replace("#","");if(n.length===3){const t=parseInt(n[0]+n[0],16),o=parseInt(n[1]+n[1],16),i=parseInt(n[2]+n[2],16);return(t*299+o*587+i*114)/1e3>128}if(n.length===6){const t=parseInt(n.substring(0,2),16),o=parseInt(n.substring(2,4),16),i=parseInt(n.substring(4,6),16);return(t*299+o*587+i*114)/1e3>128}return!1}function b(){try{const e=window.getComputedStyle(document.documentElement),n=window.getComputedStyle(document.body),t=e.getPropertyValue("--comfy-menu-bg")?.trim()||"#1a1a1a",o=e.getPropertyValue("--comfy-menu-bg-2")?.trim()||e.getPropertyValue("--comfy-menu-secondary-bg")?.trim()||"#252525",i=it(t),s=e.getPropertyValue("--comfy-menu-bg-3")?.trim();let r,a;i?(r="#f0f0f0",a=e.getPropertyValue("--comfy-input-bg")?.trim()||"#ffffff"):(r=s||"#2a2a2a",a=e.getPropertyValue("--comfy-input-bg")?.trim()||r);const c=e.getPropertyValue("--input-text")?.trim()||"",l=i?"#222222":"#dddddd",u=i?"#666666":"#999999";return{bgPrimary:t,bgSecondary:o,bgTertiary:r,inputBg:a,inputText:l,borderColor:e.getPropertyValue("--border-color")?.trim()||(i?"#dddddd":"#444444"),textPrimary:l,textSecondary:u,accentColor:e.getPropertyValue("--comfy-accent")?.trim()||"#9b59b6",errorColor:"#e74c3c",successColor:"#27ae60",isLight:i}}catch(e){return console.warn("[DataManager] Failed to get ComfyUI theme:",e),{bgPrimary:"#1a1a1a",bgSecondary:"#252525",bgTertiary:"#2a2a2a",inputBg:"#2a2a2a",inputText:"#dddddd",borderColor:"#444444",textPrimary:"#dddddd",textSecondary:"#999999",accentColor:"#9b59b6",errorColor:"#e74c3c",successColor:"#27ae60",isLight:!1}}}function k(){const e=b(),n=e.isLight?"#e0e0e0":"#3a3a3a",t=document.documentElement;t.style.setProperty("--dm-bg-primary",e.bgPrimary),t.style.setProperty("--dm-bg-secondary",e.bgSecondary),t.style.setProperty("--dm-bg-tertiary",e.bgTertiary),t.style.setProperty("--dm-bg-hover",n),t.style.setProperty("--dm-input-bg",e.inputBg),t.style.setProperty("--dm-input-text",e.inputText),t.style.setProperty("--dm-border-color",e.borderColor),t.style.setProperty("--dm-text-primary",e.textPrimary),t.style.setProperty("--dm-text-secondary",e.textSecondary),t.style.setProperty("--dm-accent-color",e.accentColor),t.style.setProperty("--dm-error-color",e.errorColor),t.style.setProperty("--dm-success-color",e.successColor)}function pe(e,n){e&&(e.style.background=`linear-gradient(135deg, ${n.bgSecondary} 0%, ${n.bgPrimary} 100%)`,e.style.borderColor=n.borderColor)}function rt(e={}){const{title:n="Data Manager",icon:t="pi-folder-open",onClose:o=null,onMinimize:i=null,onFullscreen:s=null,onRefresh:r=null}=e,a=b(),c=document.createElement("div");c.className="dm-header dm-preview-header",c.setAttribute("draggable","false"),c.style.cssText=`
  ...
  `,A(s),s.onchange=async r=>{const a=r.target.value,c=window._remoteConnectionsState;if(a==="__local__"){c.active=null;try{localStorage.removeItem("comfyui_datamanager_last_connection")}catch{}R(),t&&(await t(),A(s))}else if(a.startsWith("conn_")){const l=a.substring(5),u=c.saved.find(d=>d.id===l);if(u)try{s.disabled=!0;const d=document.createElement("option");d.textContent="连接中...",s.innerHTML="",s.appendChild(d);const{sshConnect:m}=await I(async()=>{const{sshConnect:f}=await import("./ssh.js");return{sshConnect:f}},[]),y=await m(u.host||"",u.port||22,u.username||"",atob(u.password||"")),x={...u,connection_id:y.connection_id,root_path:y.root_path};c.active=x;try{localStorage.setItem("comfyui_datamanager_last_connection",JSON.stringify(x))}catch{}R(),n&&await n(x),s.disabled=!1,A(s,n,t)}catch(d){alert("连接失败: "+d.message),s.disabled=!1,A(s)}}},i.appendChild(s),i}function A(e,n,t){const o=b(),i=window._remoteConnectionsState,s=i.active;e.innerHTML="";const r=document.createElement("option");r.value="__local__",r.textContent="本地",s||(r.selected=!0),e.appendChild(r);let a="__local__";i.saved.forEach(c=>{const l=document.createElement("option");l.value=`conn_${c.id}`,l.textContent=c.name||`${c.username}@${c.host}`,s&&s.id===c.id&&(l.style.color=o.successColor,l.selected=!0,a=l.value),e.appendChild(l)}),e.value=a}function R(){const e=b(),n=document.getElementById("dm-connection-indicator"),t=document.getElementById("dm-connection-status"),i=window._remoteConnectionsState.active;n&&(n.style.background=i?e.successColor:e.textSecondary),t&&(i?t.textContent=`SSH: ${i.username}@${i.host}`:t.textContent="")}function ct(e){const n=b(),t=document.createElement("button");return t.className="comfy-btn",t.id="dm-new-btn",t.innerHTML='<i class="pi pi-plus"></i>',t.style.cssText=`
    padding: 8px 12px;
  ...
  `,[{value:"name",label:"按名称"},{value:"size",label:"按大小"},{value:"modified",label:"按日期"}].forEach(i=>{const s=document.createElement("option");s.value=i.value,s.textContent=i.label,t.appendChild(s)}),t.onchange=i=>{const s=i.target.value;e.onSortChange&&e.onSortChange(s)},t}function dt(e){const{onSshConnect:n,onSshDisconnect:t}=e,o=b(),i=document.createElement("button");return i.className="comfy-btn",i.id="dm-settings-btn",i.innerHTML='<i class="pi pi-cog"></i>',i.style.cssText=`
    padding: 8px 12px;
    border: 1px solid ${o.borderColor} !important;
    border-radius: 6px;
    cursor: pointer;
  ...
  `,i.title="连接管理",i.onclick=async()=>{const{openSettingsPanel:s}=await I(async()=>{const{openSettingsPanel:r}=await import("./settings.js");return{openSettingsPanel:r}},[]);s({onConnect:r=>{const a=window._remoteConnectionsState;a.active=r;try{localStorage.setItem("comfyui_datamanager_last_connection",JSON.stringify(r))}catch{}R();const c=document.getElementById("dm-remote-select");c&&A(c),n&&n(r)},onDisconnect:async()=>{const r=window._remoteConnectionsState,a=r.active;if(a&&a.connection_id)try{const{sshDisconnect:l}=await I(async()=>{const{sshDisconnect:u}=await import("./ssh.js");return{sshDisconnect:u}},[]);await l(a.connection_id)}catch(l){console.log("[DataManager] SSH disconnect error:",l)}r.active=null;try{localStorage.removeItem("comfyui_datamanager_last_connection")}catch{}R();const c=document.getElementById("dm-remote-select");c&&A(c),t&&t()}})},i}function pt(e={}){const n=b(),t=document.createElement("div");t.className="dm-toolbar",t.style.cssText=`
    display: flex;
    align-items: center;
    justify-content: space-between;
    padding: 10px 15px;
  ...
  `,r.onclick=()=>I(()=>Promise.resolve().then(()=>q),void 0).then(d=>d.navigateHome()),i.appendChild(s),i.appendChild(r),o.appendChild(i);const a=document.createElement("input");a.id="dm-path-input",a.type="text",a.className="dm-input",a.style.cssText=`
    ...
    background: ${n.bgTertiary} !important;
    color: ${n.inputText} !important;
  `,a.value=p.currentPath||".",a.onkeypress=d=>{if(d.key==="Enter"){const{loadDirectory:m}=require("./actions.js");m(d.target.value)}},o.appendChild(a),o.appendChild(lt(e)),t.appendChild(o);const c=document.createElement("div");c.style.cssText="display: flex; align-items: center; gap: 10px;";const l=document.createElement("button");l.id="dm-view-toggle-btn",l.className="comfy-btn",l.title="切换视图",l.style.cssText=`
    padding: 8px 12px;
    border: 1px solid ${n.borderColor} !important;
    border-radius: 6px;
    background: ${n.bgTertiary} !important;
  ...
  `;const l=document.createElement("label");l.style.cssText=`
    ...
    font-weight: 500;
  `,l.textContent="输出格式:",c.appendChild(l);const u=n?gt(n):Object.keys(J),d=t||(n?u[0]:"png");if(s){const y=document.createElement("select");y.id="dm-format-select",y.className="comfy-combo",y.style.cssText=`
      width: 100%;
      padding: 8px 12px;
  ...
  `,o.appendChild(a),setTimeout(()=>{a.style.opacity="0",a.style.transform="translateY(-10px)",a.style.transition="all 0.3s ease-in",setTimeout(()=>a.remove(),300)},3e3)}function K(e){const n=e.replace(/\\/g,"/"),t=n.lastIndexOf("/");return t<=0?".":n.substring(0,t)}function Ce(e){return e.split(/[/\\]/).pop()||""}function Ot(e){return"."+(e.split(".").pop()?.toLowerCase()||"")}async function M(e){const n=window._remoteConnectionsState?.active;if(n){await Lt(e,n);return}P(`正在加载: ${e}...`);try{const t=await $e(e);p.files=t.files||[],p.currentPath=t.path,ne(t.path),(p.historyIndex===-1||p.history[p.historyIndex]!==t.path)&&(p.history=p.history.slice(0,p.historyIndex+1),p.history.push(t.path),p.historyIndex=p.history.length-1);const o=document.getElementById("dm-path-input");o&&(o.value=t.path),U(),P(`${p.files.length} 个项目`)}catch(t){console.error("Load directory error:",t),P("加载错误"),S("error","错误","网络请求失败")}}async function Lt(e,n){P(`正在加载远程: ${e}...`);try{const{sshList:t}=await I(async()=>{const{sshList:s}=await import("./ssh.js");return{sshList:s}},[]),o=await t(n.connection_id,e||n.root_path||"/");p.files=o.files||[],p.currentPath=o.path||e;const i=document.getElementById("dm-path-input");i&&(i.value=`[SSH] ${o.path}`),U(),P(`${p.files.length} 个项目 (远程)`)}catch(t){console.error("Load remote directory error:",t),P("加载错误"),S("error","错误",`远程加载失败: ${t.message}`)}}function U(){const e=document.getElementById("dm-file-list");if(!e)return;p.selectedFiles=[];const n=[...p.files].sort((o,i)=>{const s=o.is_dir||o.isDir||!1,r=i.is_dir||i.isDir||!1;if(s&&!r)return-1;if(!s&&r)return 1;let a=0;switch(p.sortBy){case"name":a=o.name.localeCompare(i.name);break;case"size":a=(o.size||0)-(i.size||0);break;case"modified":a=new Date(o.modified||0).getTime()-new Date(i.modified||0).getTime();break}return p.sortOrder==="asc"?a:-a});let t="";p.currentPath!=="."&&p.currentPath!=="/"&&(p.viewMode==="list"?t+=me({name:"..",path:K(p.currentPath),size:0,modified:void 0}):t+=ue({name:"..",path:K(p.currentPath)},!0)),n.forEach(o=>{t+=p.viewMode==="list"?me(o):ue(o,!1)}),e.innerHTML=t,e.scrollTop=0,e.querySelectorAll(".dm-file-item").forEach(o=>{o.onclick=()=>zt(o),o.ondblclick=()=>At(o)}),e.querySelectorAll(".dm-grid-item").forEach(o=>{o.onclick=()=>Nt(o),o.ondblclick=async()=>{const i=o.dataset.path;if(o.dataset.isDir==="true"&&i)await M(i);else if(i){const{previewFile:r}=await I(async()=>{const{previewFile:a}=await import("./preview-actions.js");return{previewFile:a}},[]);await r(i)}}})}function Ee(){const e=document.getElementById("dm-copy-path-btn");if(!e)return;const n=p.selectedFiles.length>0;e.disabled=!n,e.style.opacity=n?"1":"0.5",e.style.cursor=n?"pointer":"not-allowed"}function zt(e){const n=b();document.querySelectorAll(".dm-file-item").forEach(i=>{i.style.background="transparent"}),e.style.background=`${n.bgTertiary} !important`;const t=e.dataset.path||"",o=e.dataset.isDir==="true";p.selectedFiles=[t],Ee(),!o&&t?(async()=>{const{previewFile:i}=await I(async()=>{const{previewFile:s}=await import("./preview-actions.js");return{previewFile:s}},[]);await i(t)})():Ft()}function Nt(e){const n=b();document.querySelectorAll(".dm-grid-item").forEach(i=>{i.style.borderColor="transparent"}),e.style.borderColor=`${n.accentColor} !important`,p.selectedFiles=[e.dataset.path||""],Ee();const t=e.dataset.path;!(e.dataset.isDir==="true")&&t&&(async()=>{const{previewFile:i}=await I(async()=>{const{previewFile:s}=await import("./preview-actions.js");return{previewFile:s}},[]);await i(t)})()}function At(e){const n=e.dataset.path;e.dataset.isDir==="true"&&n?M(n):n&&(async()=>{const{previewFile:o}=await I(async()=>{const{previewFile:i}=await import("./preview-actions.js");return{previewFile:i}},[]);await o(n)})()}function Ft(){const e=document.getElementById("dm-preview-content");if(e){const n=b();e.innerHTML=`
...
`?(t.push(o),n.push(t),t=[],o=""):r!=="\r"&&(o+=r)}return t.push(o),(t.length>0||n.length>0)&&n.push(t),n}const qt={type:"floating",maxRows:_.MAX_PREVIEW_ROWS,height:null},Q={floating:{containerClass:"dm-table-container",controlsClass:"dm-table-controls",height:null,hasFullscreen:!1,prefix:"dm-floating-table"},panel:{containerClass:"dm-panel-table-container",controlsClass:"dm-table-controls-panel",height:null,hasFullscreen:!0,prefix:"dm-table"}};function Fe(e,n={}){const t={...qt,...n},o=Q[t.type||"floating"],i=t.hasFullscreen!==void 0?t.hasFullscreen:o.hasFullscreen,s=e.slice(0,t.maxRows||_.MAX_PREVIEW_ROWS),r=e.length>(t.maxRows||_.MAX_PREVIEW_ROWS),a=`${o.prefix}-${Date.now()}`,c=t.path||"",l=o.height!==null?`height: ${o.height};`:"height: 100%;",u=`position: relative; flex: 1; overflow: hidden; ${l}`;let d=`
  ...
  `,r){const m=t.maxRows||_.MAX_PREVIEW_ROWS;d=d.replace("</div>",`<div class="dm-table-truncated" style="text-align: center; padding: 10px; font-size: 11px;">... (仅显示前 ${m} 行，共 ${e.length} 行)</div></div>`)}return setTimeout(()=>Be(a,t.type||"floating",i,c),0),d}function Wt(e,n){let t=`
  ...
  `}async function He(e,n){const t=await fetch(`/dm/preview?path=${encodeURIComponent(e)}`);if(!t.ok)throw new Error("Failed to load file");if(n===".csv"){const o=await t.text();return Ut(o)}if(n===".xls"||n===".xlsx"){const o=window;typeof o.XLSX>"u"&&await Ae("https://cdn.sheetjs.com/xlsx-0.20.2/package/dist/xlsx.full.min.js");const i=await t.arrayBuffer(),s=o.XLSX,r=s.read(i,{type:"array"}),a=r.SheetNames[0],c=r.Sheets[a];return s.utils.sheet_to_json(c,{header:1})}throw new Error("Unsupported spreadsheet format")}const hn=Object.freeze(Object.defineProperty({__proto__:null,createTableErrorHTML:je,createTableHTML:Fe,parseSpreadsheet:He,setupTableControls:Be},Symbol.toStringTag,{value:"Module"}));async function Gt(e,n,t,o=1,i){const s=b();e.innerHTML=`
  ...
  `;try{let r="";if(w.image.exts.includes(t)){const a=`/dm/preview?path=${encodeURIComponent(n)}`;r=`
      ...
      `}else if(w.code.exts.includes(t)){const a=await fetch(`/dm/preview?path=${encodeURIComponent(n)}`);if(a.ok){const c=await a.text();r=`
        ...
        `}}else if(w.spreadsheet.exts.includes(t))try{const a=await He(n,t);r=Fe(a,{type:"floating",hasFullscreen:!0,path:n})}catch(a){r=je(a.message)}else{const a=n.split(/[/\\]/).pop()||"",c=W({name:n}),l=w[c]?.icon||w.unknown.icon,u=w[c]?.color||w.unknown.color;r=`
    ...
    flex-direction: column;
    overflow: hidden;
  `;const g=Jt(n,r,a,c,l,m,y,x,f);f.appendChild(g);const v=document.createElement("div");v.id=`dm-preview-content-${Date.now()}`,v.style.cssText=`
    flex: 1;
    overflow: auto;
    display: flex;
    align-items: center;
    justify-content: center;
    background: ${o.bgPrimary};
  `,f.appendChild(v);const{toolbar:C,mediaId:T}=en(e,i,a,c,l,u,d,y,x,v,f);f.appendChild(C);const $=document.createElement("div");$.id=`dm-fileinfo-${Date.now()}`,$.className="dm-floating-file-info",$.style.cssText=`
    padding: 10px 15px;
  ...
  `,$.innerHTML='<span style="opacity: 0.5;">正在加载...</span>',f.appendChild($),document.body.appendChild(f),k(),we(f,g);const B={path:e,fileName:n,fileConfig:r,window:f,minimized:!1};O.push(B),Gt(v,e,i,Zt,T),P(`已打开预览: ${n}`)}function Jt(e,n,t,o,i,s,r,a,c,l){const u=b(),d=u.isLight?"#222":"#fff",m=document.createElement("div");m.className="dm-preview-header",m.style.cssText=`
    ...
    cursor: move;
    user-select: none;
  `;const y=document.createElement("div");y.className="dm-traffic-lights",y.style.cssText="display: flex; gap: 8px;";const x=X("pi-times",d,"关闭",()=>tn(c));y.appendChild(x);const f=X("pi-minus",d,"最小化",()=>nn(c));if(y.appendChild(f),t||o||i||s||r||a){const v=X("pi-window-maximize",d,"全屏",()=>V(c));y.appendChild(v)}m.appendChild(y);const g=document.createElement("div");return g.className="dm-header-title-area",g.style.cssText="display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 600; flex: 1; justify-content: center;",g.innerHTML=`
  ...
  `;const y=document.createElement("div");y.style.cssText="display: flex; gap: 8px; align-items: center; flex-shrink: 0;";const x=document.createElement("div");x.style.cssText="flex: 1; text-align: center; overflow: hidden; padding: 0 20px;";const f=document.createElement("div");f.style.cssText="display: flex; gap: 8px; align-items: center; flex-shrink: 0;";function g(){const T=document.createElement("div");return T.style.cssText=`width: 1px; height: 16px; background: ${d.borderColor}; margin: 0 4px;`,T}t&&y.appendChild(g()),(n===".txt"||n===".rtf"||n===".md"||n===".docx")&&Kt(y,l,n,D,g),a&&Qt(y,l,n,D,g);const v=document.createElement("div");v.className="dm-file-path",v.style.cssText=`overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: ${d.textSecondary};`,v.textContent=e,v.title=e,x.appendChild(v),f.appendChild(g());let C;if(t)C=`dm-floating-image-${Date.now()}`,se(f,C,l,e,D,g);else if(o||i)C=o?`dm-preview-video-${Date.now()}`:`dm-preview-audio-${Date.now()}`,Re(f,l,e,o,D,g,u,C);else{const T=D("pi-external-link","打开",()=>{window.open(`/dm/preview?path=${encodeURIComponent(e)}`,"_blank")});f.appendChild(T)}if(s){f.appendChild(g());const T=D("pi-arrows-alt","PDF 全屏",()=>{const $=document.getElementById("dm-floating-pdf-embed");$&&$.requestFullscreen?$.requestFullscreen().catch(B=>console.error("[DataManager] PDF 全屏失败:",B)):$&&$.webkitRequestFullscreen&&$.webkitRequestFullscreen()});f.appendChild(T)}if(n===".md"||n===".txt"||n===".rtf"){f.appendChild(g());const T=D("pi-arrows-alt","全屏预览",()=>V(u));f.appendChild(T)}if(a){f.appendChild(g());const T=D("pi-arrows-alt","全屏预览",()=>V(u));f.appendChild(T)}if(c){f.appendChild(g());const T=D("pi-arrows-alt","全屏预览",()=>V(u));f.appendChild(T)}return m.appendChild(y),m.appendChild(x),m.appendChild(f),{toolbar:m,mediaId:C}}function se(e,n,t,o,i,s){const r=b(),a=t.querySelector(`#${n}`);if(!a){setTimeout(()=>se(e,n,t,o,i,s),50);return}let c=100,l=0,u=0;const d=document.createElement("span");d.id=`${n}-zoom`,d.className="dm-zoom-level",d.style.cssText=`min-width: 45px; text-align: center; font-size: 13px; color: ${r.textSecondary};`,d.textContent="100%",e.appendChild(d);function m(){const $=c/100;a.style.transform=`translate(${l}px, ${u}px) scale(${$})`,d.textContent=`${c}%`,c>100?(a.style.maxWidth="none",a.style.maxHeight="none"):(a.style.maxWidth="100%",a.style.maxHeight="100%")}const y=i("pi-search-minus","缩小",()=>{c=Math.max(c-_.DEFAULT_ZOOM_STEP,_.MIN_ZOOM_DISPLAY),m()});e.appendChild(y);const x=i("pi-search-plus","放大",()=>{c=Math.min(c+_.DEFAULT_ZOOM_STEP,_.MAX_ZOOM_DISPLAY),m()});e.appendChild(x);const f=i("pi-undo","重置",()=>{c=100,l=0,u=0,m()});e.appendChild(f),e.appendChild(s());const g=i("pi-external-link","打开",()=>{window.open(`/dm/preview?path=${encodeURIComponent(o)}`,"_blank")});e.appendChild(g);const v=a.parentElement;v&&v.addEventListener("wheel",$=>{$.preventDefault();const B=$.deltaY>0?-25:_.DEFAULT_ZOOM_STEP;c=Math.max(_.MIN_ZOOM_DISPLAY,Math.min(_.MAX_ZOOM_DISPLAY,c+B)),m()},{passive:!1});let C=!1,T={x:0,y:0};a.addEventListener("mousedown",$=>{c<=100||(C=!0,T={x:$.clientX-l,y:$.clientY-u},a.style.cursor="grabbing")}),document.addEventListener("mousemove",$=>{C&&(l=$.clientX-T.x,u=$.clientY-T.y,m())}),document.addEventListener("mouseup",()=>{C&&(C=!1,a.style.cursor="grab")})}function tn(e){const n=O.findIndex(t=>t.window===e);n>-1&&O.splice(n,1),e.remove(),re()}function nn(e,n,t,o){const i=O.find(s=>s.window===e);i&&(i.minimized=!0),e.style.display="none",re()}function V(e){e.dataset.fullscreen==="true"?(e.dataset.fullscreen="false",e.style.top="100px",e.style.right="50px",e.style.width="500px",e.style.height="600px"):(e.dataset.fullscreen="true",e.style.top="0",e.style.right="0",e.style.width="100vw",e.style.height="100vh",e.style.borderRadius="0")}const on=Object.freeze(Object.defineProperty({__proto__:null,openFloatingPreview:Ve,setupImageToolbarControls:se},Symbol.toStringTag,{value:"Module"})),rn=2,sn=typeof L.ui<"u"&&L.ui!==null&&L.ui?.version&&typeof L.ui.version=="object"&&L.ui.version.major&&L.ui.version.major>=rn;console.log(`[DataManager] Extension loading, Node V${sn?"3":"1"} detected`);let Z=null;const an={name:"ComfyUI.DataManager",commands:[{id:"data-manager.open",label:"Open Data Manager",icon:"pi pi-folder-open",function:()=>j()}],keybindings:[{combo:{key:"d",ctrl:!0,shift:!0},commandId:"data-manager.open"}],actionBarButtons:[{icon:"pi pi-folder",tooltip:"文件管理器 (Ctrl+Shift+D)",class:"dm-actionbar-btn",onClick:()=>j()}],async setup(){window.FileManagerState=p,k();const e=document.createElement("style");e.textContent=`
      .dm-actionbar-btn {
    ...
    `,document.head.appendChild(e);const n=()=>{try{k();const r=document.documentElement.style.getPropertyValue("--dm-bg-tertiary")}catch(s){console.warn("[DataManager] Theme apply error:",s)}};n(),setTimeout(n,0),setTimeout(n,100),setTimeout(n,500);const t=()=>{const s=document.querySelector(".dm-actionbar-btn"),r=Array.from(document.querySelectorAll("button")).find(l=>l.getAttribute("aria-label")==="Expand job queue");if(!s||!r)return!1;k();const a=r.parentElement;return r.previousElementSibling!==s||s.parentElement!==a?(a.insertBefore(s,r),!0):!1};let o=0;new MutationObserver(s=>{const r=Date.now();if(r-o<100)return;o=r,s.some(c=>{if(c.type==="childList"){for(const l of c.addedNodes)if(l.nodeType===1){const u=l;if(u.classList?.contains("actionbar-container")||u.classList?.contains("dm-actionbar-btn")||u.querySelector?.(".dm-actionbar-btn")||u.querySelector?.('[aria-label="Expand job queue"]'))return!0}}return!!c.target.closest?.(".actionbar-container")})&&requestAnimationFrame(t)}).observe(document.body,{childList:!0,subtree:!0}),setInterval(()=>{t()},2e3),console.log("[DataManager] Extension setup completed"),ot(),oe(s=>{document.querySelectorAll(".dm-node-open-btn").forEach(r=>{const a=r;a.style.background=s.bgTertiary,a.style.borderColor=s.borderColor,a.style.color=s.textPrimary})})},async nodeCreated(e){const n=e;if(n.comfyClass==="DataManagerCore"){if(n.addDOMWidget){k();const t=b(),o=document.createElement("div");o.style.cssText=`
        ...
        `,i.onmouseover=()=>{i.style.background=t.bgSecondary,i.style.transform="translateY(-1px)",i.style.borderColor=t.accentColor,i.style.boxShadow="0 4px 8px rgba(0, 0, 0, 0.3)"},i.onmouseout=()=>{i.style.background=t.bgTertiary,i.style.transform="translateY(0)",i.style.borderColor=t.borderColor,i.style.boxShadow="0 2px 4px rgba(0, 0, 0, 0.2)"},i.onclick=s=>{s.stopPropagation(),j()},o.appendChild(i),n.addDOMWidget("dm_open_btn","dm_open_btn",o,{minWidth:200,minHeight:50})}}else if(n.comfyClass==="InputPathConfig")n._dmFormatSelectorEnabled=!1;else if(n.comfyClass==="OutputPathConfig"){const t=n;t._dmOutputType="STRING",t._dmFilePath=""}},getNodeMenuItems(e){return e.comfyClass==="DataManagerCore"?[{content:"打开文件管理器",callback:()=>j()}]:[]},getCanvasMenuItems(){return[null,{content:"Data Manager",callback:()=>j()}]}};function j(){Z&&fe();const e=he();e&&e!=="."?p.currentPath=e:p.currentPath=".",Z=St({onRefresh:()=>M(p.currentPath),onClose:()=>{fe(),Z=null},onOpenFloating:()=>{const t=p.selectedFiles[0];t&&Ve(t,Ce(t))},onCopyPath:()=>ln(),onDelete:()=>dn(),onSortChange:t=>{Te(t)},onNewFile:()=>pn(),onSshConnect:async t=>{const o=t,i=window._remoteConnectionsState;i.active=t;try{localStorage.setItem("comfyui_datamanager_last_connection",JSON.stringify(t))}catch{}await M(o.root_path||"/"),S("success","已连接",`SSH: ${o.username}@${o.host}`)},onSshDisconnect:async()=>{const t=window._remoteConnectionsState,o=t.active;if(o&&o.connection_id)try{const{sshDisconnect:i}=await I(async()=>{const{sshDisconnect:s}=await import("./ssh.js");return{sshDisconnect:s}},[]);await i(o.connection_id)}catch(i){console.log("[DataManager] SSH disconnect error:",i)}t.active=null;try{localStorage.removeItem("comfyui_datamanager_last_connection")}catch{}await M("."),S("info","已断开","SSH 连接已断开")}}),k(),M(p.currentPath),setTimeout(()=>{cn()},500)}function cn(){try{wt()}catch(e){console.log("[DataManager] Error in checkAndUpdateFormatSelector:",e)}}function ln(){const e=p.selectedFiles;if(e.length===0){S("warn","未选择","请先选择文件");return}const n=e.join(`
