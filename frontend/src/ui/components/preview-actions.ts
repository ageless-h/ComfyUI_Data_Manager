...
export function setupImageZoomControls(imageId: string): void {
  ...
  const zoomOutBtn = document.querySelector(`.dm-zoom-out-btn[data-image-id="${imageId}"]`) as HTMLButtonElement;
  const zoomInBtn = document.querySelector(`.dm-zoom-in-btn[data-image-id="${imageId}"]`) as HTMLButtonElement;
  const resetBtn = document.querySelector(`.dm-zoom-reset-btn[data-image-id="${imageId}"]`) as HTMLButtonElement;
