...
describe('listDirectory', () => {
  ...
  it('should handle error response with message field', async () => {
    ...
    await expect(listDirectory('/path')).rejects.toThrow('Failed to list directory: Server error')
  })
  ...
  it('should handle error response without specific message', async () => {
    ...
    await expect(listDirectory('/path')).rejects.toThrow('Failed to list directory: HTTP 403')
  })
  ...
  it('should handle malformed JSON response', async () => {
    ...
    await expect(listDirectory('/path')).rejects.toThrow('Failed to list directory: HTTP 500')
  })
})
...
describe('createFile', () => {
  ...
  it('should handle error response', async () => {
    ...
    await expect(createFile('/path', '')).rejects.toThrow('Invalid filename')
  })
  ...
  it('should use message field when error is missing', async () => {
    ...
    await expect(createFile('/path', 'file.txt')).rejects.toThrow('Permission denied')
  })
})
...
describe('createDirectory', () => {
  ...
  it('should handle error response', async () => {
    ...
    await expect(createDirectory('/path', 'existing')).rejects.toThrow('Directory already exists')
  })
})
...
describe('deleteFile', () => {
  ...
  it('should handle error response', async () => {
    ...
    await expect(deleteFile('/invalid.txt')).rejects.toThrow('File not found')
  })
  ...
  it('should handle malformed error response', async () => {
    ...
    await expect(deleteFile('/path/file.txt')).rejects.toThrow('Unknown error')
  })
})
